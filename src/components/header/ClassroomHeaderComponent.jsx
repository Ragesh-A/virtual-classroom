...
const ClassroomHeaderComponent = () => {
  ...
  <>
    <ul className="flex items-center">
      <NavLink to="/" className="border-t-4 border-transparent hover:border-white text-white font-bold p-[15px] me-1 nav">
        <i className="fa-solid fa-people-roof sm:hidden"></i>
        <li className="hidden sm:block">My class</li>
      </NavLink>
      <li>
        <button className="border-t-4 border-transparent hover:border-white text-white font-bold p-[15px] me-1 nav"
          onClick={popHandle}>
      ...
      <NavLink to="/meetup"
        className="border-t-4 border-transparent hover:border-white text-white font-bold p-[15px] me-1 nav">
