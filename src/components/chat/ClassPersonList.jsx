...
const ClassPersonList = ({ back, onlineUsers, myId }) => {
  ...
  return (
    <div className="relative">
      ...
      <p className="font-mono text-sm font-bold tracking-widest py-2 my-1">
        Members in the class
      </p>
      <button
        className="text-sm font-bold bg-gray-400 text-white p-2 rounded w-full"
        onClick={() => setActiveForm((prev) => (prev ? false : true))}
      >
