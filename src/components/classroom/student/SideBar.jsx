...
const SideBar = ({ toggle, setToggle}) => {
  ...
  return(
    ...
    <ul className={`flex flex-col fixed w-15 overflow-hidden p-2 h-[75vh] rounded-md side-bar bg-tileColor ${toggle ? 'active': ''} border-2`} >
      ...
      <NavLink to={`/class/${classId}/works/`} className="mt-2 SideBar-tab">
          <button className={`flex gap-5 items-center py-3 px-8 rounded shadow font-bold  w-full text-left hover:bg-indigo-500 hover:text-white h-[3rem]`} >
      ...
      <NavLink to={`/class/${classId}/works/completed`} className="mt-2 SideBar-tab">
          <button className={`flex gap-5 py-3 px-8 rounded shadow w-full text-left hover:bg-indigo-500 hover:text-white font-bold  items-center `} >
      ...
      <NavLink to={`/class/${classId}/works/missed`} className="mt-2 SideBar-tab">
          <button className={`flex gap-5 items-center py-3 px-8 rounded shadow font-bold  w-full text-left hover:bg-indigo-500 hover:text-white`} >
