...
const BottomBar = ({ setSlider, isPermissionAccessed }) => {
		...
		<div className='bg-tileColor p-3 rounded-md flex justify-center border-2 border-white shadow'>
			<div className=''>
				<ul className='flex gap-2 md:gap-5'>
                  ...
                  <i className={`ri-mic-off-fill ${isPermissionAccessed ? 'text-blue-900' : 'text-gray-500'}  md:text-2xl`}></i>
							)}
						</button>
					</li>
					<li>
                  ...
                  <i className={`ri-camera-off-fill  ${isPermissionAccessed ? 'text-blue-900' : 'text-gray-500'} md:text-2xl`}></i>
							)}
						</button>
					</li>
					<li>
